...
start1 = timer()    
alpha , b = (simplified_SMO(1,0.0005,1,text_x_2,text_t_2))  
...
start2 = timer()
alpha , b = (simplified_SMO(1,0.0005,1,text_x_3,text_t_3))  
